# Helper macro to add compile flags to specific languages
macro(sps_add_compile_flags langs)
  foreach(_lang ${langs})
...
# Helper macro to set source file compile flags for Objective-C files
macro(sps_set_source_files_compile_flags)
  foreach(file ${ARGN})
